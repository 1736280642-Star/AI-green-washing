  ...
  return (
    <>
      ...
      {!compact && <section className="dashboard-band dense-band governance-band" aria-labelledby="governance-title">
        <header className="dashboard-band-heading"><div><span className="section-kicker">MODEL & DATA GOVERNANCE</span><h2 id="governance-title">复核一致性与来源新鲜度</h2></div><span className="band-context">EAA-ESGSI-DEMO-1.0 · 合成样本</span></header>
