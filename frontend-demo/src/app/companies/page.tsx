...
import { ArrowLeft, ArrowRight, ArrowUpDown, Download, GitCompareArrows, Save, Search, Settings2, X } from "lucide-react";
...
export default function CompaniesPage() {
  ...
  function exportCsv() {
    const rows = table.getFilteredRowModel().rows.map(({ original }) => [original.companyName, original.stockCode, original.industry, original.riskScore, original.evidenceCoverage]);
