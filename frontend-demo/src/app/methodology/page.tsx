...
const methods=[
  {id:"eass",title:"EASS · 环境行动实质性",formula:"Σ Salienceᵢ × ASᵢ；ASᵢ=(Iᵢ+αPᵢ)/(Iᵢ+Pᵢ+Dᵢ)",direction:"越高表示重点环境议题有更多已实施行动支撑",threshold:"低于 0.50 建议复核",example:"先按五类环境 Aspect 计算频率、Salience 与行动分数，再聚合到公司年度。",status:"Aspect 与 α 均版本化"},
